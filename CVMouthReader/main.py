...
from modules.audio_data import process_transcript

def main():
    # Paths
    video_path = "CVMouthReader/data/input/smithscut.mp4"
    frames_dir = "CVMouthReader/data/input/frames"
    ...
    detect_faces_and_mouths(frames_dir, output_csv, face_mouth_dir, output_frame_interval=1)
